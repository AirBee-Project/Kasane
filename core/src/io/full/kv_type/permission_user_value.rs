...
impl Value for UserCommand {
        ...
        Self: 'a,
    {
        ...
        match data[0] {
            ...
            5 => UserCommand::GrantUser,
            6 => UserCommand::GrantDatabase,
            7 => UserCommand::GrantSpace,
            8 => UserCommand::GrantKey,
            9 => UserCommand::RevokeUser,
            10 => UserCommand::RevokeDatabase,
            11 => UserCommand::RevokeSpace,
            12 => UserCommand::RevokeKey,
