use crate::{AppState, error::AppError, models::query::Query, repositories::table::write::SpatialDbWrite};
...
pub async fn value_remove(
    ...
    //データベースの操作と反映
    crate::repositories::table::value::write::value_remove(table.id, ids)?;
    db.commit()
}
